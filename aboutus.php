...
<html >
<head>
	<title> KiiTHelper | About Us </title>
...
<div class="aboutUs">
	<div class="aboutUs__firstBox">
		<h2 class="aboutUs__mission">
			Our goal is to change the way you find anything around KIIT. You are one step away.
		</h2>
		<p class="aboutUs__content">
    Hey Students ever faced difficulty in finding restaurants around KIIT or were you ever stuck in finding a place to visit with family and friends around KIIT or did you waste your time during the exam week running after the teachers,friends and librarian for the question papers.. KiiTHelper is the solution for all your problems..
	</p>
...
<div class="aboutUs__quarterBox">
			...
			<div class="content">
				<h5>Systematize</h5>
				<p>
				 KiiT Helper is designed in such a way that you will easily find your way in the site. 
				</p>
			</div>
		</div>
...
<div class="aboutUs__quarterBox">
			...
			<div class="content">
				<h5>Benefactor</h5>
				<p>
				 Helps student in matters of day to day study, university exams and placements.
				</p>
			</div>
		</div>
        ...
        <div class="aboutUs__quarterBox">
			...
			<div class="content">
				...
				<p>
				KiiT Helper uses technology to provide our users  a seamless awesome experience.
				</p>
			</div>
		</div>
