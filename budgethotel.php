...
<html >
<head>
	<title> KiiTHelper | Budget Hotel </title>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2  style="margin-left: 150px;">Restaurants near the KIIT road &nbsp;&nbsp;&nbsp;&nbsp;<span><a  href="../index.php" style="box-sizing: border-box;height: 13px;width: 15px;background-color: #c0392b;color: #fff;border-radius: 8px;padding: 3px;">Change Location</a></span></h2></div>
<div class="aboutUs__secondBox" style="height: 4800px; background: url('');">
<div class="aboutUs__quarterBox" style="width: 1100px; height: 4500px;margin-left: 90px;">
              <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/bhaibhai.jpg');"></div><br />
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/challange.jpg');" ></div><br />
         	<div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/campuscafe1.jpg');"></div><br />
               <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/dakhin9.jpg');" ></div><br />
            ...
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/grandkalinga.jpg');" ></div><br />
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/99north.jpg');" ></div><br /> 
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/tasteburd1.png');" ></div><br />
	    	<div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/ckitchen.jpg');" ></div><br />
