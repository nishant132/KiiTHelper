...
<div class="aboutUs">
	<div class="aboutUs__firstBox">
		...
		Banged your head to decide where to go on holidays need not be worried Here's the Solution
		</h2>
...
<div class="aboutUs__secondBox" style="height: 2000px; background: url('');">
<div class="aboutUs__quarterBox" style="width: 1400px; height: 1700px; float: left;margin-left:145px" >
