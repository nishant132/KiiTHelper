...
<html >
<head>
	<title> KiiTHelper | Infocity area's Restaurants </title>
...
<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2  style="margin-right: 150px;">Restaurants near the-&nbsp; Infocity Area &nbsp;&nbsp;&nbsp;&nbsp;<span><a href="restaurants.php"style="box-sizing: border-box;height: 13px;width: 15px;background-color: #c0392b;color: #fff;border-radius: 8px;padding: 3px;">Change Location</a></span></h2>
<div class="aboutUs__secondBox" style="height: 2700px; background: url('');">
<div class="aboutUs__quarterBox" style="width: 1100px; height: 2400px;margin-left: 90px;">
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/bhaibhai.jpg');" ></div><br />
         	...
         	<div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/99north.jpg');"></div><br />
              <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/merillia.jpg');"></div><br />
               <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/thehub.jpg');" ></div><br />
             <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/aangan.jpg');" ></div><br />
               <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/hibhubaneswar.jpg');" ></div><br />
