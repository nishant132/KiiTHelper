...
<html >
<head>
	<title> KiiTHelper | Patia side Restaurants </title>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2  style="margin-left: 150px;">Restaurants near the Patia Area &nbsp;&nbsp;&nbsp;&nbsp;<span><a  href="restaurants.php" style="box-sizing: border-box;height: 13px;width: 15px;background-color: #c0392b;color: #fff;border-radius: 8px;padding: 3px;">Change Location</a></span></h2></div>
<div class="aboutUs__secondBox" style="height: 3300px; background: url('');">
<div class="aboutUs__quarterBox" style="width: 1100px; height: 3000px;margin-left: 90px;">
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/garammasala.jpg');" ></div><br />
             ...
             <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/sachi.jpg');" ></div><br />
               <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/seventhh.jpg');" ></div><br />
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/kalingac.jpg');" ></div><br />
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/hblue.jpg');" ></div><br />
            <div class="imageDiv imageDiv--first" style="width: 900px; height: 300px; background: url('./images/ommsom.jpg');" ></div><br />
